# This script calculates the distance from each species occurrence point to its
# nearest road or trail using OpenStreetMap data. The analysis is performed in chunks
# for memory efficiency, and includes multiple validation tests to ensure accuracy of
...
FROM st_read('data/place_roads_2025-04-22-2.gpkg')
...
con |> dbExecute(
  sprintf(
    "COPY (SELECT * FROM nearest_trail) TO 'data/occ_nearest_trail_%s-2.csv';",
...
trail_results <- read_csv("data/occ_nearest_trail_2025-04-22-2.csv")
