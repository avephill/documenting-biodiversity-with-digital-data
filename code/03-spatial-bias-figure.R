# This script creates a multi-panel figure showing spatial bias patterns
# in species occurrence data. It combines road networks, occurrence density rasters,
# Nearest Neighbor Index (NNI) analyses, and distance-to-road distributions to compare
# spatial patterns between iNaturalist observations and herbarium specimens.
...
## Trails  ---------------------------------------
trails <- st_read("data/place_roads_2025-04-22-2.gpkg")
...
nearest_trail <- read_csv("data/occ_nearest_trail_2025-04-22-2.csv") # |>
