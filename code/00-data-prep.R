# This script processes GBIF plant occurrence data for three California regions
# (Santa Monica Mountains, One Tam, and Marble/Salmon Mountains), joining it with
# boundary data and verifying taxa against a curated species list. The processed
# data is saved in both parquet and geopackage formats.
