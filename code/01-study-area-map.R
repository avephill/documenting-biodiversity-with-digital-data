# This script creates an overall visualization of the three study areas in
# California, including their locations, ecoregion classifications, and elevation
# ranges. The script generates a multi-panel figure combining a state-level map,
# detailed ecoregion maps for each study area, and representative photographs.
